...
hi Folded       guibg=#1a1823 guifg=#5080c0 "bbbbcc
...
if &term == "builtin_gui" || &term == "win32"
    hi Comment guifg=darkgrey  guibg=#251f35
else
...
hi Conditional  gui=None guifg=#ba405a guibg=bg
hi Repeat       gui=None guifg=#e03d5a guibg=bg
hi Label        gui=None guifg=LightGreen guibg=bg
hi Operator     gui=None guifg=#baaa55 guibg=bg
hi Keyword      gui=bold guifg=grey guibg=bg
hi Exception    gui=none guifg=#ea5460 guibg=bg
