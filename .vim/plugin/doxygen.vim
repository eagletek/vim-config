...
iabbr _DFH <C-R>=DoxyFuncComment()<CR><ESC>XXi*<esc>?/\*\*<CR><ESC>:noh<CR>
...
iabbr _DMH <C-R>=DoxyFileComment()<CR><ESC>XXi*<esc>?/\*\*<CR><ESC>:noh<CR>
...
" returns the text for a file comment
