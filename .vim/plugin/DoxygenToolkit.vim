...
if !exists("g:DoxygenToolkit_structTag")
	let g:DoxygenToolkit_structTag = "@struct "
endif
if !exists("g:DoxygenToolkit_enumTag")
	let g:DoxygenToolkit_enumTag = "@enum "
endif
if !exists("g:DoxygenToolkit_namespaceTag")
	let g:DoxygenToolkit_namespaceTag = "@namespace "
endif
...
" BKK: Add the classification to blocks (defaults to unclassified)
if !exists("g:DoxygenToolkit_classificationTag_pre")
	let g:DoxygenToolkit_classificationTag_pre = "Classification: Unclassified "
endif
...
function! <SID>DoxygenAuthorFunc()
  ...
  let l:insertionMode = s:StartDocumentationBlock()
    ...
    " BKK: adding rcs flags to header
    exec "normal o" . g:DoxygenToolkit_interCommentTag
    exec "normal o" . g:DoxygenToolkit_interCommentTag . g:DoxygenToolkit_classificationTag_pre
    exec "normal o" . g:DoxygenToolkit_interCommentTag
...
function! <SID>DoxygenCommentFunc()
  ...
  if( g:DoxygenToolkit_compactOneLineDoc =~ "yes" && l:doc.returns != "yes" && len( l:doc.params ) == 0 )
    ...
    " class/struct/enum/namespace tags
    if (l:doc.type == "class")
        let s:declTag = s:interCommentTag.g:DoxygenToolkit_classTag.l:doc.name
    elseif (l:doc.type == "struct")
        let s:declTag = s:interCommentTag.g:DoxygenToolkit_structTag.l:doc.name
    elseif (l:doc.type == "enum")
        let s:declTag = s:interCommentTag.g:DoxygenToolkit_enumTag.l:doc.name
    elseif (l:doc.type == "namespace")
        let s:declTag = s:interCommentTag.g:DoxygenToolkit_namespaceTag.l:doc.name
    endif

    if (s:declTag != "")
        exec "normal ".l:insertionMode.s:declTag
    endif
  ...
  " BKK: add the classification tag
  exec "normal o" . g:DoxygenToolkit_interCommentTag
  exec "normal o" . g:DoxygenToolkit_interCommentTag . g:DoxygenToolkit_classificationTag_pre
